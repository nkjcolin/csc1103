          ...
          gpointer        user_data)
{
  ...
  gtk_window_set_title (GTK_WINDOW (window), "Tick Tac");
...
/*row 3 column 1  */
    button = gtk_button_new_with_label ("Button 7");
  g_signal_connect (button, "clicked", G_CALLBACK (print_hello), NULL);
...
/*row 3 column 2  */
    button = gtk_button_new_with_label ("Button 8");
  g_signal_connect (button, "clicked", G_CALLBACK (print_hello), NULL);
...
/*row 3 column 2  */
    button = gtk_button_new_with_label ("Button 9");
  g_signal_connect (button, "clicked", G_CALLBACK (print_hello), NULL);
